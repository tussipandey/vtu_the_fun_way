...
<script src="https://ajax.googleapis.com/ajax/libs/jqueryui/1.12.1/jquery-ui.min.js"></script>
    ...
    <body>
        ...
        <p align="right">
            <button id="login" class="btn btn-primary" data-target="#myInquiry"  data-toggle="modal" data-ordernumber="1122">Login</button>
             
        <button id="login2" class="btn btn-primary" onclick="location.href = 'http://tussipandey.thecompletewebhosting.com/form4.php';">Signup</button>
        </p> 
